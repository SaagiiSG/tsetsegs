...
export default function FloatingLines({
  ...
  // If color prop is provided, use it as gradient
  const effectiveGradient = linesGradient ?? (color ? [color] : undefined);
  ...
  useEffect(() => {
    ...
    if (effectiveGradient && effectiveGradient.length > 0) {
      ...
      stops.forEach((hex, i) => {
        const colorVec = hexToVec3(hex);
        (uniforms.lineGradient.value as Vector3[])[i].set(colorVec.x, colorVec.y, colorVec.z);
      });
    }
