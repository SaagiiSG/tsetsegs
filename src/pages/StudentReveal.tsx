      ...
      <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Button
                  ...
                  className="bg-gold/20 hover:bg-gold/30 text-gold border-2 border-gold text-2xl py-8 px-12 rounded-xl backdrop-blur-sm transition-all hover:scale-105"
                >
                  English
                </Button>
                <Button
        ...
        {currentPanel === 1 && language && (
          ...
          >
            ...
            >
              <motion.h2
                className="text-5xl md:text-6xl font-bold text-gold mb-8"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
