...
REVOKE ALL ON FUNCTION public.proctor_finalize_session(uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.proctor_finalize_session(uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.proctor_finalize_session(uuid) TO service_role;